...
function TermsPage(): ReactElement {
  return (
    ...
    >
      ...
      <p>Welcome to Stonkify!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Stonkify's Website, located at stonkify.io.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Stonkify if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Stonkify, you agreed to use
        cookies in agreement with the Stonkify's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Stonkify and/or its licensors own the
        intellectual property rights for all material on Stonkify. All
        intellectual property rights are reserved. You may access this from
        Stonkify for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Stonkify</li>
        <li>Sell, rent or sub-license material from Stonkify</li>
        <li>Reproduce, duplicate or copy material from Stonkify</li>
        <li>Redistribute content from Stonkify</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Stonkify does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Stonkify,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Stonkify shall not be liable
      ...
      <p>
        Stonkify reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Stonkify a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Stonkify; and (d) the link is
      ...
      <p>
        ...
        e-mail to Stonkify. Please include your name, your organization name,
      ...
      <p>
        No use of Stonkify's logo or other artwork will be allowed for linking
